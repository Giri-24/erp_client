                      ...
                      <tr id={`student-row-${s.id}`} className="transition-all group hover:bg-slate-50/50">
                        ...
                        <td>
                          <div className="flex items-center justify-end gap-2">
                             ...
                             {/* demote button  */}
                              <button onClick={() => handleDemote(s)} className="flex items-center justify-center text-yellow-600 transition-all shadow-sm w-9 h-9 rounded-xl bg-yellow-50 hover:bg-yellow-600 hover:text-black" title="Demote"><span className="material-symbols-outlined text-[18px] leading-none">arrow_downward</span></button>
                             {/* Archive button */}
